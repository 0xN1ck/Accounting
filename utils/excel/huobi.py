...
def write_to_to_excel_huobi_history_p2p_buy(filename, sheet, workbook, huobi_history_p2p_buy_sum):
    ...
    for name_coin in huobi_history_p2p_buy_sum.index:
        ...
        if not name_coin == 'USDT':
            value_common_price = huobi_history_p2p_buy_sum.loc[name_coin]['Общая цена'].iloc[index[name_coin]] if not one_coin else huobi_history_p2p_buy_sum.loc[name_coin]['Общая цена']
            ...
            value_price = huobi_history_p2p_buy_sum.loc[name_coin]['Цена за ед.'].iloc[index[name_coin]] if not one_coin else huobi_history_p2p_buy_sum.loc[name_coin]['Цена за ед.']
            ...
            value_amount = huobi_history_p2p_buy_sum.loc[name_coin]['Количество'].iloc[index[name_coin]] if not one_coin else huobi_history_p2p_buy_sum.loc[name_coin]['Количество']
        ...
        value_rub = huobi_history_p2p_buy_sum.loc[name_coin]['Общая цена'].iloc[index['USDT']] if not one_coin else huobi_history_p2p_buy_sum.loc[name_coin]['Общая цена']

        value_usdt = huobi_history_p2p_buy_sum.loc[name_coin]['Количество'].iloc[index['USDT']] if not one_coin else huobi_history_p2p_buy_sum.loc[name_coin]['Количество']
