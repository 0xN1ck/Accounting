...
def write_to_excel_bybit_history_p2p(filename, sheet, workbook, filtered_data_bybit_history_p2p_buy):
    ...
    for name_coin in filtered_data_bybit_history_p2p_buy.index:
        ...
        if not name_coin == 'USDT':
            value_common_price = filtered_data_bybit_history_p2p_buy.loc[name_coin]['Fiat Amount'].iloc[index[name_coin]] if not one_coin else filtered_data_bybit_history_p2p_buy.loc[name_coin]['Fiat Amount']
            ...
            value_price = filtered_data_bybit_history_p2p_buy.loc[name_coin]['Price'].iloc[index[name_coin]] if not one_coin else filtered_data_bybit_history_p2p_buy.loc[name_coin]['Price']
            ...
            value_amount = filtered_data_bybit_history_p2p_buy.loc[name_coin]['Coin Amount'].iloc[index[name_coin]] if not one_coin else filtered_data_bybit_history_p2p_buy.loc[name_coin]['Coin Amount']
        ...
        value_rub = filtered_data_bybit_history_p2p_buy.loc[name_coin]['Fiat Amount'].iloc[index['USDT']] if not one_coin else filtered_data_bybit_history_p2p_buy.loc[name_coin]['Fiat Amount']

        value_usdt = filtered_data_bybit_history_p2p_buy.loc[name_coin]['Coin Amount'].iloc[index['USDT']] if not one_coin else filtered_data_bybit_history_p2p_buy.loc[name_coin]['Coin Amount']

        value_mean = filtered_data_bybit_history_p2p_buy.loc[name_coin]['Price'].iloc[index['USDT']] if not one_coin else filtered_data_bybit_history_p2p_buy.loc[name_coin]['Price']
